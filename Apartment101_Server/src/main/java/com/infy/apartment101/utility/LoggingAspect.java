package com.infy.apartment101.utility;
...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.infy.apartment101.dao.*Impl.*(..))", throwing = "exception")
	public void logExceptionFromDAO(Exception exception) throws Exception {
		log(exception);
	}

	@AfterThrowing(pointcut = "execution(* com.infy.apartment101.service.*Impl.*(..))", throwing = "exception")
